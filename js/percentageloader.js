...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
        ...
        percentageText.style.height = '45px';
        ...
        tubeGrad.addColorStop(0, '#2e2e2e');
        tubeGrad.addColorStop(1, '#2e2e2e');
        ...
        innerBarRadius = innerRadius + (cX * 0.04);
        outerBarRadius = radius - (cX * 0.04);
        ...
        drawLoader = function () {
            ...
            /*** TEXT ***/
            (function () {
                var fontSize, string, smallSize, heightRemaining, heightSmallSize;
                ...
                percentageText.style.color = '#f1f1f1';
                percentageText.style.font = fontSize.toString() + "px 'Open Sans', sans-serif";
                percentageText.style.textShadow = '0 1px 1px #555';
                ...
                smallSize = cX / 6.5;
                heightSmallSize = cX / 4.5;
                valueText.style.color = '#f1f1f1';
                valueText.style.font = smallSize.toString() + "px 'Open Sans', sans-serif";
                valueText.style.height = heightSmallSize.toString() + 'px';
                valueText.style.textShadow = '0 1px 1px #555';
