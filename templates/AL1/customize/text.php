...
function ssdma_customize_register_text($wp_customize)
{
    ...
    // Text inline
    $wp_customize->add_setting('ssdma_text_line', array(
        'default' => 'Smarter Shopping, Better Living!',
        'capability' => 'edit_theme_options',
        'type' => 'option',
        'sanitize_callback' => 'ssdma_nothing'
    ));
    $wp_customize->add_control('ssdma_text_line', array(
        'priority' => 1,
        'label' => __('Text inline', 'ssdma'),
        'section' => 'ssdma_text_settings',
        'settings' => 'ssdma_text_line',
    ));
