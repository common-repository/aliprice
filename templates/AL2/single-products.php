<?php get_header(); ?>
    ...
    <div class="container base-mar-t-20">
	    ...
	    <div class="grid-900 grid-m-23 b-product-single clearfix">
		    <div class="b-product-single_main">
                <h1><?php the_title(); ?></h1>
			...
			<div class="col-lg-12 col-md-12 col-sm-24 col-xs-24 b-product-single_main_right">
                ...
                <div class="b-product_price">
                    <?php if ( $price && $sale && ( $price != $sale ) ): ?>
                        <div>
                            ...
                            <strong class="b-product_min"> / <?php echo $info->getPackageType(); ?></strong><br/>
                        </div>
                        <div>
				...
				<div class="b-product_desc">
					<table>
						<tr>
							<th><img src="<?php echo get_template_directory_uri(); ?>/public/images/box-single.jpg" width="45" height="39" alt="45 days Money back"/></th>
							<td>
								<strong><?php _e( '45 days Money back', 'ssdma' ); ?></strong>&nbsp;<?php _e( 'Returns accepted if product not as described, buyer pays return shipping; or keep the product & agree refund with seller.', 'ssdma' ); ?>
							</td>
						</tr>
						<tr>
							<th><img src="<?php echo get_template_directory_uri(); ?>/public/images/car-single.jpg" width="45" height="40" alt="On-time Delivery"/></th>
							<td>
								<strong><?php _e( 'On-time Delivery', 'ssdma' ); ?></strong><br/><?php _e( 'Guarantees: On-time Delivery 60 days', 'ssdma' ); ?>
							</td>
						</tr>
					</table>
				</div>
    ...
    <!--     <div class="b-product_store">
                             <span><?php // _e( 'Sort By', 'ssdma' ); ?>:</span>&nbsp;
				...
				<div class="b-social-squared">
					<table>
						<tr>
							<td><h3><?php _e( 'Share', 'ssdma' ); ?>:</h3></td>
							<td><?php get_template_part( 'templates/social-more' ); ?></td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div class="b-product_description_tabs">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
				    <a href="#product" aria-controls="product" role="tab" data-toggle="tab"><?php _e( 'Product Description', 'ssdma' ); ?></a>
				</li>
				<li role="presentation">
				    <a href="#reviews" aria-controls="reviews" role="tab" data-toggle="tab"><?php _e( 'Reviews', 'ssdma' ); ?><?php comments_number( '', '(1)', '(%)' ); ?></a>
				</li>
				<li role="presentation">
				    <a href="#payment" aria-controls="payment" role="tab" data-toggle="tab"><?php _e( 'Shipping and payment', 'ssdma' ); ?></a>
                </li>
				<li role="presentation">
				    <a href="#sellers" aria-controls="sellers" role="tab" data-toggle="tab"><?php _e( "Seller Guarantees", "ssdma" ); ?></a>
				</li>
			</ul>
			<div class="tab-content">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<table class="feedback_average_table">
								...
								<tr>
									<td>
										<span class="progress_title"><?php _e( '4 Stars', 'ssdma' ) ?>
											(<?php echo $stat['stars'][4]['count'] ?>)</span>
								...
								<?php foreach ( $arrayOfObjs as $key => $obj ) : ?>
									...
									<tr>
										<td class="star-text">
											...
											<span>
                                                <img src="<?php echo get_template_directory_uri(); ?>/public/images/flags/<? echo strtoupper( $obj->flag ) ?>.gif"/>
                                            </span>
										</td>
										<td class="star-text">
											<div class="b-product_rate">
												    <?php foreach ( ssdma_rating( $obj->star ) as $star ): ?>
				...
				<div role="tabpanel" class="tab-pane" id="payment">
					<table class="table table-responsive table-bordered">
						...
						<tbody>
						<tr>
							<th><img src="<?php echo get_template_directory_uri(); ?>/public/images/icon-dhl.jpg" width="90" height="30" alt="DHL"/></th>
							<td></td>
							<td>3 - 7 <?php _e( 'days', 'ssdma' ); ?></td>
						</tr>
						<tr>
							<th><img src="<?php echo get_template_directory_uri(); ?>/public/images/icon-ups-e.gif" width="82" height="34" alt="UPS Expedited"/></th>
							<td></td>
							<td>3 - 7 <?php _e( 'days', 'ssdma' ); ?></td>
						</tr>
						<tr>
							<th><img src="<?php echo get_template_directory_uri(); ?>/public/images/icon-ems.jpg" width="70" height="30" alt="EMS"/></th>
							<td></td>
...
<form method="POST" action="<?php echo esc_html( home_url('/') ) ?>" class="b-product_order">
	...
	<div class="clearfix"></div></div><?php get_template_part( 'templates/footer-before' ); ?>
    <div id="modal_form">
        <span id="modal_close">X</span>
        <div class="modal_title text-center"><?php _e('Do you know that you can <span>save up to 90%</span> on your<br> online shopping, buying directly from manufacturers?', 'ssdma') ?></div>
        <div class="modal_subtitle"><?php _e('And it is very easy:', 'ssdma') ?></div>
        <ul class="modal_ul">
            <li><?php _e('Go to', 'ssdma') ?> <a href="<?php echo get_option( 'aliprice-alibaba_href' )?>" target="_blank">Alibaba.com</a> <?php _e('and enter the wanted item into search field.', 'ssdma') ?></li>
        ...
        <a class="btn btn-orange text-center" href="<?php echo get_option( 'aliprice-alibaba_href' )?>" target="_blank"><?php _e('GO TO ALIBABA', 'ssdma') ?></a>
    </div>
