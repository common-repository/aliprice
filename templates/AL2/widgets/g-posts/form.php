<p>
	<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title', 'ssdma'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id( 'atitle' ); ?>"><?php _e('Auto title: ', 'ssdma'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php _e('Order: ', 'ssdma'); ?></label>
	<?php 
...
<p>
	<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e('Count:', 'ssdma'); ?></label>
	<input type="text" class="widefat" 
...
<p>
	<label for="<?php echo $this->get_field_id( 'cat' ); ?>"><?php _e('Category: ', 'ssdma'); ?></label>
	<?php 
