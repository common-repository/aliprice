...
class Ali_Products extends WP_Widget
{
	...
	public function __construct()
	{
		...
		parent::__construct( false, 'Ali Products', array(
			'description' => __( 'Output portable products', 'gdn' ),
		) );
	}
