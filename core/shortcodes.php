<?php 
	...
	*/
	add_shortcode( 'ali_product', 'aliprice_shortcode_product' );
	function aliprice_shortcode_product( $attr ) {
	...
	*/
	add_shortcode( 'aebox', 'aliprice_shortcode_type_a' );
	function aliprice_shortcode_type_a( $attr ) {
		...
		$btn = '<a class="btn" href="' . $url . '" ' . $n . ' target="' . $t . '">' . __("Buy now", 'aliprice') . '</a>';
					...
					<?php switch( $layout ) { 
						...
						case "img-left-text-right" : ?>
							...
							<div class="content">
								...
								<p class="price"><?php _e("List Price", 'aliprice') ?>: <span><?php echo $price ?></span></p>
								<?php echo $btn ?>
							</div>
							<?php break;
